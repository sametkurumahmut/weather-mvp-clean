...
open class ActivityCompatPermissionClient @Inject constructor(private val activity: Activity)
    : PermissionClient {
    ...
    override fun hasPermissions(vararg permissions: String) =
            permissions.all {
                ContextCompat
                        .checkSelfPermission(this.activity, it) == PackageManager.PERMISSION_GRANTED
            }
    ...
    override fun shouldShowRequestPermissionRationale(vararg permissions: String) =
            PermissionClientUtil.compatShouldShowRequestPermissionRationale(
                    this.activity,
                    *permissions)
